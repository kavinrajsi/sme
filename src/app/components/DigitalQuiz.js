...
const quizData = [
  {
    ...
    grid: true,
    options: [
      { label: "🛍️ Retail / E-commerce", value: "retail", score: 5 },
      { label: "🍽️ Food & Hospitality", value: "food", score: 4 },
      ...
      { label: "⚙️ Other", value: "other", score: 4 },
    ],
  },
  {
    key: "website",
    ...
    options: [
      ...
      {
        label: "⚠️ Yes — but it's outdated or rarely gets visitors",
        value: "yes_basic",
        score: 5,
      },
  ...
  },
  {
    ...
    options: [
      ...
      { label: "▶️ YouTube", value: "youtube", score: 6 },
  ...
  },
  {
    ...
    options: [
      {
        label: "🗣️ Word of mouth / Referrals",
        value: "referral",
        score: 3,
      },
  ...
  },
  {
    ...
    options: [
      ...
      {
        label: "⚙️ Automate follow-ups & lead management",
        value: "automate",
        score: 3,
      },
      {
  ...
  },
  {
    ...
    options: [
      ...
      {
        label: "⚔️ Losing customers to digital-first competitors",
        value: "competition",
        score: 2,
      },
      {
